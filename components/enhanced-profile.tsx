...
import { User, MapPin, Mail, Phone, Languages, Briefcase, Download, MessageCircle } from "lucide-react"
      ...
      <CardContent className="p-0">
        ...
        <div className="bg-gradient-to-r from-zinc-800/50 to-zinc-900/50 p-4 sm:p-6 flex flex-col items-center border-b border-zinc-800">
          ...
          <Button
            variant="outline"
            size="sm"
            className="mb-4 bg-zinc-800/50 hover:bg-zinc-700 border-zinc-700 text-cyan-400 hover:text-cyan-300"
            asChild
          >
            <a href="/Karan_Saket_Resume.pdf" download="Karan_Saket_Resume.pdf" className="flex items-center">
        ...
        <Tabs defaultValue="about" className="w-full" onValueChange={setActiveTab}>
          ...
          <TabsContent value="about" className="p-4 sm:p-6 space-y-4 sm:space-y-6 focus:outline-none">
            <div className="space-y-3">
              <h3 className="text-sm font-medium text-zinc-400 flex items-center">
                <User className="w-4 h-4 sm:w-4 sm:h-4 mr-1 sm:mr-2" />
                About Me
              </h3>
            ...
            {/* <div className="space-y-3">
              <h3 className="text-sm font-medium text-zinc-400 flex items-center">
                <Briefcase className="w-4 h-4 sm:w-4 sm:h-4 mr-1 sm:mr-2" />
                Professional Focus
              </h3>
            ...
            <div className="space-y-3">
              <h3 className="text-sm font-medium text-zinc-400 flex items-center">
                <Languages className="w-4 h-4 sm:w-4 sm:h-4 mr-1 sm:mr-2" />
                Languages
              </h3>
              <div className="space-y-3">
          ...
          <TabsContent value="contact" className="p-4 sm:p-6 space-y-4 focus:outline-none">
            <div className="space-y-4">
              ...
              <div className="pt-4">
                <ContactFormDialog isOpen={isContactDialogOpen} onClose={() => setIsContactDialogOpen(false)} />
              </div>
            </div>
          </TabsContent>
        </Tabs>
